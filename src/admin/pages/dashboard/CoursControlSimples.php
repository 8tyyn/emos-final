    ...
    <div class="template-page-wrapper">
      ...
      <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
          ...
          <h1>Manager les Cours Simples</h1>
          <p>Voiçi le tableau des cours</p>

          <div class="row margin-bottom-30">
            <div class="col-md-12">
              <ul class="nav nav-pills">
                <li class="active"><a href="#">Nombre de cours Simples <span class="badge">4</span></a></li>
              </ul>          
            </div>
          </div> 
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="table-responsive">
                <h4 class="margin-bottom-15">Tableau de Cours Simples</h4>
