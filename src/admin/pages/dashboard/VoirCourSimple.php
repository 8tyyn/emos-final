    ...
    <div class="template-page-wrapper">
      ...
      <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
          ...
          <h1>H1 Tag</h1> 
          <p>P Tag</p>
          <button class='btn btn-success' name='modifier_cour' type='submit'><a href="GoModifyCourSimple.php">Modifier</a></button>
          <button class='btn btn-danger' name='retour' type='submit'><a href="CoursControlSimples.php">Retour</a></button>
        </div>
      </div>
      <style>
        .templatemo-content {
